...
Requirements: Node 26, Corepack 0.35, pnpm 11, Docker Compose, curl, and a GitHub OAuth app. Node 26
does not bundle Corepack, so install it once with `npm install --global corepack@0.35.0`.
