...
Read the root `AGENTS.md`, `apps/ingest/AGENTS.md`, ADRs 0015 through 0020 and 0033, the threat
model, abuse cases, privacy data map, and this workspace's `README.md` before changing the host.
