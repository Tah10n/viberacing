...
const english = {
  ...
  activeDevicesCopy:
    "Only active device credentials are listed; source state can still block submission. Revoking one is permanent, stops its future submissions immediately, and keeps existing season attribution.",
  activeDevicesTitle: "Connected devices",
  activeDevicesUnavailable: "Connected-device details are temporarily unavailable.",
  ...
  noActiveDevices: "No device currently has submission access.",
  passkeyCopy:
...
const russian: Record<JoinTranslationKey, string> = {
  ...
  activeDevicesCopy:
    "Показаны только активные права устройств; состояние источника может отдельно блокировать отправку. Отзыв необратим, сразу останавливает будущие отправки устройства и не удаляет уже учтённые сезоны.",
  activeDevicesTitle: "Подключённые устройства",
  activeDevicesUnavailable: "Сведения о подключённых устройствах временно недоступны.",
  ...
  noActiveDevices: "Сейчас ни у одного устройства нет права отправки данных.",
  passkeyCopy:
