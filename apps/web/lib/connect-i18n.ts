...
const english = {
  ...
  copy: "Review the exact local connector before giving it access to submit self-reported Community activity for a new or existing source.",
  device: "Device",
...
const russian: Record<ConnectTranslationKey, string> = {
  ...
  copy: "Проверьте локальный коннектор перед тем, как разрешить ему отправлять заявленную активность сообщества для нового или существующего источника.",
  device: "Устройство",
  error:
