...
-- Revision 0018: keep terminal source unlink independent from public visibility.
...
SELECT pg_catalog.pg_advisory_xact_lock(824_762_002);
...
CREATE OR REPLACE FUNCTION viberacing_api.unlink_source(
  p_session_id uuid,
  p_session_verifier_digest bytea,
  p_source_id text,
  p_challenge_id uuid,
...
REVOKE EXECUTE ON FUNCTION viberacing_api.unlink_source(
...
VALUES (18, 'hidden_profile_source_unlink');
