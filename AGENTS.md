...
fresh revocation of an owned non-current passkey, and logout through the same probed read-write
...
passkey addition, recovery, edge abuse controls, or deployment. A library-only Rust connector
