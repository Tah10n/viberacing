...
тихий выход с кодом 0, закрытие DB session и неизменность runtime fingerprint. Это локальное
post-startup signal evidence, а не deployed controller или orchestrator grace. Команда
