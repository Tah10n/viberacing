...
- The database public score model contains only fields explicitly classified Public. The complete
  HTTP model and cache remain planned. Authenticated responses are private and `no-store`; public
