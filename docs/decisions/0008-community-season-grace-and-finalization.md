...
emitted paths prove one local recurring callback and three local emitted signal paths, not deployed
OS-signal routing or controller/orchestrator grace, a deployed cleanup cadence, monitoring,
