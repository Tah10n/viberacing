...
is fixed-clock composition and real-clock emitted-process terminal-marker evidence, but no
controller settlement before forced termination, recurring timer-callback, graceful
process-signal/PostgreSQL result, or deployed cadence. A disabled switch therefore must not claim to
