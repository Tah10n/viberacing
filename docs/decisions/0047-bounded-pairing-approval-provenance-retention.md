...
in-memory local catalog, sequential execution, and no-overlap lifecycle. There is no combined
scheduler/PostgreSQL result, deployed cadence, durable missed-slot recovery, monitoring, capacity
