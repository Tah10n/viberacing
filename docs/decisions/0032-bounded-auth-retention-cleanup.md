...
live Jobs login/TLS connection, backup-expiry proof, or deployed retention policy exists. Expired
sessions, deletion jobs/tombstones, historical passkey provenance, pairing rate windows, and any
future expiring class still require separate reviewed rules. Recovery also still needs distributed
attempt controls and deployment-owned pepper/timing evidence.
