...
- [Community sync authentication policy](../../contracts/v1/connector-sync-authentication.json)
- [Shared synthetic signing vector](../../contracts/v1/connector-sync-device-request.test-vector.json)
