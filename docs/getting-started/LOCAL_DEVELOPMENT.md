...
and thirty-five checksum-ledgered database migrations. Repository verification uses synthetic data
...
narrow and negative-control logins, runs all thirteen built commands, verifies generic output and
