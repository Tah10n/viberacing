...
passkey inventory, an account page, and logout. It has no working invite/OAuth/database credential
or live-authenticator evidence, and recovery, pairing approval, a Jobs scheduler, real-user
