...
matched days, at least three distinct positive totals, and no overlapping complete mismatch are
required. A deterministic oldest matching account becomes the root; the single-source account is
