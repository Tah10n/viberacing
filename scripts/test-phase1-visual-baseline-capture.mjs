...
const accessibilityNodes = [
  ...
  ...[
    ...
    "HOW RANKING WORKS",
    "View profile: neon_otter",
    "View profile: syntax_spark",
    "View profile: demo_driver",
    "View profile: loop_lantern",
    "View profile: pixel_pulse",
    "View profile: stack_rover",
    "View profile: cache_comet",
    "View profile: debug_dash",
